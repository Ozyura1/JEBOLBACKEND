...
import '../service/admin_ktp_service.dart';
import '../../../core/network/api_result.dart';

/// Provider for Admin KTP module state management.
class AdminKtpProvider extends ChangeNotifier {
  final AdminKtpService _service;

  AdminKtpProvider([AdminKtpService? service])
    : _service = service ?? AdminKtpService();

  // State
  List<KtpSubmission> _submissions = [];
  KtpSubmission? _selectedSubmission;
  ...
  // Getters
  List<KtpSubmission> get submissions => _submissions;
  KtpSubmission? get selectedSubmission => _selectedSubmission;
    ...
    try {
      ...
      if (data is List) {
        _submissions = data
            .map(
              (e) =>
                  e is Map<String, dynamic> ? KtpSubmission.fromJson(e) : null,
            )
            .whereType<KtpSubmission>()
            .toList();
  ...
  Future<void> loadDetail(String id) async {
    ...
    try {
      ...
      if (data is Map<String, dynamic>) {
        _selectedSubmission = KtpSubmission.fromJson(data);
      }
  ...
  Future<bool> scheduleSubmission(
    ...
    try {
      ...
      _successMessage = 'Jadwal berhasil ditetapkan.';
      _isProcessing = false;
      notifyListeners();
